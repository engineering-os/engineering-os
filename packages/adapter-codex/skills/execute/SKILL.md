...
Use this skill when the user asks Codex to execute an EOS plan or implement from a previously approved feature plan.
...
3. Execute tasks in dependency order. Parallelize only when the current Codex environment and user request make that safe.
